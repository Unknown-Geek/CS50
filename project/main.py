...
# Scrolling Background.Used AI tools for implementing this feature.
...
while running:
    ...
    # Increase difficulty over time.Used AI tools for implementing this feature.
    current_time = pygame.time.get_ticks() / 1000.0
    if current_time - last_difficulty_increase > 10:
    ...
    # Enemy movement (zigzag pattern).Used AI tools for implementing this feature.
    for i in range(no_enemies):
    ...
    # AI hand tracking.Used AI tools for implementing the controls for right hand.
